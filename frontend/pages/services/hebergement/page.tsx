...
const amenityImages = [
  ...
  { image: "https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?w=400&q=80", label: "Petit-déjeuner inclus" },
  { image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&q=80", label: "Restaurant africain & européen" },
  ...
  { image: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=400&q=80", label: "Salle de réunion" },
];
    ...
    <div className="min-h-screen">
      <section className="relative text-white py-20 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=1600&q=80" alt="Hébergement" className="w-full h-full object-cover opacity-90" />
          <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-black/10" />
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <h1 className="text-2xl sm:text-2xl sm:text-4xl md:text-5xl font-bold mt-2 mb-4">Hébergement & Restauration</h1>
            <p className="text-gray-100 text-lg leading-relaxed">
              Hôtels, résidences meublées, campings et restaurant africain & européen sur le littoral ivoirien.
              Des solutions pour tous les séjours : tourisme, affaires, événements.
            </p>
            <a href="#chambres" className="btn-primary mt-8 inline-flex">
              Voir les hébergements <ArrowRight size={18} />
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f0f9ff]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-title text-center mb-10">Équipements & services</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="section-title mt-2">Tous types d'hébergement</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
            {[
              { label: "Hôtels de luxe", stars: 5, slug: "hotels-luxe", image: "https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=400&q=80" },
              { label: "Hôtels standards", stars: 3, slug: "hotels-standards", image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=400&q=80" },
              { label: "Résidences bord de mer meublées", stars: 0, slug: "residences", image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=400&q=80" },
              { label: "Auberges et gîtes", stars: 0, slug: "auberges", image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400&q=80" },
              { label: "Campings aménagés", stars: 0, slug: "campings", image: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=400&q=80" },
              { label: "Locations courte durée (Airbnb-style)", stars: 0, slug: "locations-courte-duree", image: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=400&q=80" },
            ].map((t) => (
          ...
          <div className="bg-[#f0f9ff] rounded-2xl p-5 border border-[#bae6fd] text-center">
            <p className="text-sm text-[#0c4a6e] font-medium flex items-center justify-center gap-2">
              <UtensilsCrossed size={16} className="text-[#c9a84c]" /> <strong>Restauration incluse</strong> — Restaurant africain &amp; européen disponible sur place
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="chambres" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="section-title mt-2">Choisissez votre hébergement</h2>
          </div>
