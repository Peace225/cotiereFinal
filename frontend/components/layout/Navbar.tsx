...
const services = [
  ...
  { label: "Guide Touristique",      href: "/services/tourisme",    Icon: Waves },
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <Link href="/submit" 
                className={`text-sm py-2 px-4 rounded-lg font-medium transition-colors border ${
                  scrolled ? "border-[#0c4a6e] text-[#0c4a6e] hover:bg-[#0c4a6e] hover:text-white" 
      ...
      <div className={`fixed inset-0 z-40 lg:hidden transition-all duration-300 ${mobileOpen ? "visible" : "invisible"}`}>
        ...
        <div className={`absolute top-0 right-0 h-full w-80 max-w-[90vw] bg-white shadow-2xl transition-transform ${mobileOpen ? "translate-x-0" : "translate-x-full"}`}>
          {/* ... (contenu du menu mobile reste inchangé, utilisez simplement 'session' ici aussi) */}
          <div className="px-4 py-4 border-t border-gray-100 space-y-2">
             <Link href={accountHref} className="flex items-center gap-2 w-full px-4 py-3 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50">
