...
import { Camera, Video, Mic, Aperture, Play, ArrowRight, CheckCircle2, Image as ImageIcon, MessageCircle } from "lucide-react";
...
export default function HblStudioPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-24 pb-16">
      ...
      {/* HEADER / HERO SECTION (Design immersif sombre responsive) */}
