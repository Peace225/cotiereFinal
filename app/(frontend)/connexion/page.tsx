...
export default function ConnexionPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (res?.error) {
      ...
      // Vérifier si un callbackUrl est présent dans l'URL
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Email ou Username</label>
              <div className="relative">
                <Mail size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
                <input type="text" required placeholder="email ou nom d'utilisateur"
            ...
            <div className="flex justify-end">
              <Link href="/mot-de-passe-oublie" className="text-xs text-[#38bdf8] hover:underline">
                Mot de passe oublié ?
              </Link>
            </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/inscription" className="text-[#38bdf8] font-semibold hover:underline">
              S'inscrire
            </Link>
          </p>
        </div>
