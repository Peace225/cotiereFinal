...
// Remplace par le VRAI numÃ©ro WhatsApp de l'administrateur (sans le + et avec l'indicatif)
...
export default function InscriptionPartenairePage() {
  const [form, setForm] = useState({ 
    ...
    password: "", 
    phone: "",
    activity: "" // Nouveau champ pour le secteur d'activitÃ©
  });
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Validation du secteur d'activitÃ©
    if (!form.activity) {
      setError("Veuillez sÃ©lectionner un secteur d'activitÃ©.");
      return;
    }
    ...
    try {
      // 1. (Optionnel) Sauvegarde en base de donnÃ©es via ton API
      ...
      // 2. GÃ©nÃ©ration du message WhatsApp pour l'admin
      const message = `*NOUVELLE DEMANDE PARTENAIRE - CÃ”TIÃˆRE MEDIA* ðŸš€\n\n` +
        `*Nom :* ${form.lastName} ${form.firstName}\n` +
        `*Email :* ${form.email}\n` +
        `*WhatsApp :* ${form.phone}\n` +
        `*Secteur d'activitÃ© :* ${form.activity}\n\n` +
      ...
      // 3. Affiche l'Ã©cran de succÃ¨s
      setIsSubmitted(true);
      
    } catch (err) {
      setError("Impossible de contacter le serveur. Veuillez rÃ©essayer.");
    } finally {
      setLoading(false);
    }
  }

  // --- VUE SUCCÃˆS (APRÃˆS SOUMISSION) ---
  if (isSubmitted) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f0f9ff] px-4 py-12">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-sm border border-blue-100 p-8 text-center animate-in fade-in zoom-in duration-500">
          ...
          <h2 className="!text-[18px] md:!text-[20px]font-black text-slate-900 mb-2">Demande envoyÃ©e !</h2>
          <p className="text-slate-600 mb-6">
            Si WhatsApp ne s'est pas ouvert automatiquement, cliquez sur le bouton ci-dessous pour envoyer vos informations Ã  l'administrateur.
          </p>
          <div className="bg-blue-50 p-4 rounded-xl text-left mb-8 border border-blue-100">
            <p className="text-sm font-bold text-blue-900 flex items-center gap-2 mb-2">
              <MessageCircle size={18} /> Prochaine Ã©tape :
            </p>
            <p className="text-sm text-blue-800">
              L'administrateur va vÃ©rifier votre demande et vous transmettra votre <strong>Code Marchand</strong> directement dans la discussion WhatsApp.
            </p>
          </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f0f9ff] px-4 py-12">
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 items-start">
        ...
        {/* COLONNE GAUCHE : EXPLICATION DE LA PROCÃ‰DURE */}
        <div className="md:sticky md:top-12">
          <div className="mb-8">
            ...
            <h1 className="!text-[20px] md:!text-[25px] font-black text-[#0c4a6e] mt-6 leading-tight">
              Devenez Partenaire et boostez votre visibilitÃ©
            </h1>
            <p className="text-sm-600 mt-4 text-lg">
              Une procÃ©dure sÃ©curisÃ©e et rapide pour accÃ©der Ã  votre espace de gestion dÃ©diÃ©.
            </p>
          </div>

          <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
            <h3 className="!text-[11px] md:!text-[12px] font-black text-slate-900 mb-6 flex items-center gap-2">
              <ShieldCheck className="text-blue-600" /> ProcÃ©dure d'activation
            </h3>
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">Remplissez le formulaire. Vous serez redirigÃ© vers WhatsApp pour finaliser.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">L'administrateur vous transmet votre code de paiement sÃ©curisÃ© via WhatsApp.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">Une fois le paiement validÃ©, vos accÃ¨s au Dashboard sont dÃ©bloquÃ©s instantanÃ©ment.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-1.5">PrÃ©nom</label>
              ...
              <div>
                ...
                <input type="text" required placeholder="KouamÃ©"
            ...
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-1.5">NumÃ©ro WhatsApp</label>
              <div className="relative">
            ...
            {/* NOUVEAU CHAMP : SECTEUR D'ACTIVITÃ‰ */}
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-1.5">Secteur d'activitÃ©</label>
              <div className="relative">
                ...
                >
                  <option value="" disabled>SÃ©lectionnez votre domaine</option>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPwd ? "text" : "password"} required placeholder="Min. 8 caractÃ¨res"
              ...
              <p className="text-xs text-slate-500 mt-2">Ce mot de passe restera confidentiel (non envoyÃ© sur WhatsApp).</p>
            </div>
            ...
            <button type="submit" disabled={loading}
              ...
              {loading ? "GÃ©nÃ©ration en cours..." : <><span>Soumettre</span><ArrowRight size={20} /></>}
            </button>
          </form>

          <p className="text-center text-sm text-slate-500 mt-8">
            Vous avez dÃ©jÃ  Ã©tÃ© validÃ© ?{" "}
