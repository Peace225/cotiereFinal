...
const ROOMS = [
  { name: "Chambre Confort", price: "40 000", capacity: 2, surface: 28, image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&q=80", features: ["Salle de bain privÃ©e", "TV Ã©cran plat", "Climatisation"] },
  { name: "Chambre Standard Double", price: "30 000", capacity: 2, surface: 22, image: "https://images.unsplash.com/photo-1631049421450-348ccd7f8949?w=600&q=80", features: ["Douche privÃ©e", "Wifi inclus", "Vue jardin"] },
...
const INCLUS = [
  "Petit-dÃ©jeuner continental inclus",
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      <section className="relative h-72 overflow-hidden">
        <img src="https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=1600&q=80" alt="HÃ´tels standards" className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-8 max-w-6xl mx-auto">
          ...
          <h1 className="text-4xl font-black text-white">HÃ´tels Standards</h1>
          <p className="text-white/80 mt-2 max-w-xl">Confort et praticitÃ© Ã  prix accessible. IdÃ©al pour les voyageurs d'affaires, les familles et les sÃ©jours de courte durÃ©e.</p>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10 sm:px-6 lg:px-8 space-y-10">
        ...
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {[
              { icon: <ShowerHead size={15} />, label: "Douche privÃ©e" },
              ...
              { icon: <ShowerHead size={15} />, label: "SÃ¨che-cheveux" },
              { icon: <Star size={15} />, label: "Kit hygiÃ¨ne de base" },
            ].map((e, i) => (
        ...
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-xl font-bold text-[#0c4a6e] mb-5">Ã‰quipements</h2>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              { icon: <Tv size={20} className="text-[#38bdf8]" />, label: "TV Ã©cran plat" },
        ...
        <div className="bg-gradient-to-r from-[#0c4a6e] to-[#0e5a82] rounded-2xl p-8 text-center text-white">
          <h3 className="text-2xl font-bold mb-2">RÃ©servez votre chambre</h3>
          <p className="text-white/70 mb-6">Ã€ partir de 30 000 FCFA/nuit Â· Petit-dÃ©jeuner inclus</p>
