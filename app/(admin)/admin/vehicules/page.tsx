...
export default function AdminVehiculesPage() {
  ...
  // ── Chargement des véhicules depuis la DB ─────────────────────────────────
  ...
  async function deleteVehicule(id: string) {
    ...
    else alert("Impossible de supprimer ce véhicule.");
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {tab === "vehicules" && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {loadingVehicules ? (
              <div className="col-span-3 py-12 text-center text-gray-400">Chargement des véhicules...</div>
            ) : vehicules.length === 0 ? (
              <div className="col-span-3 py-12 text-center text-gray-400">Aucun véhicule. Cliquez sur "Ajouter" pour commencer.</div>
            ) : vehicules.map(v => (
